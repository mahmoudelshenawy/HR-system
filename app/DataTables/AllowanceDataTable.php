...
class AllowanceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('employee', 'salary.allowance.datatable-columns.employee')
            ->addColumn('action', 'salary.allowance.datatable-columns.action')
    ...
    {
        return $this->builder()
            ->setTableId('allowancesdatatable-table')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    ['extend' => 'export', 'className' => 'btn btn-secondary', 'text' => '<i class="fa fa-file-pdf-o"> ' . trans('datatable.export') . '</i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'title' => trans('salary.allowance_amount'),
                "orderable" => false,
                "exportable" => false,
                "printable" => false,
                'sortable' => false,
    ...
    {
        return 'allowances_' . date('YmdHis');
    }
}
