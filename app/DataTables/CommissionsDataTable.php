...
class CommissionsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('employee', 'salary.commission.datatable-columns.employee')
            ->addColumn('action', 'salary.commission.datatable-columns.action')
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'title' => trans('salary.commission_amount'),
                "orderable" => false,
                "exportable" => false,
                "printable" => false,
                'sortable' => false,
