...
class FixedAllowanceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'business-setup.fixed_allowance.datatable_columns.action')
            ->rawColumns([
                'action',
            ]);
    }
     ...
     */
    public function query(FixedAllowance $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('fixedAllowance-table')
    ...
    {
        return 'FixedAllowance_' . date('YmdHis');
    }
}
