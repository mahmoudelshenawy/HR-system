...
class GracePeriodDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'time_management.grace_period.datatable_columns.action')
            ->rawColumns([
                'action',
     ...
     */
    public function query(GracePeriod $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'minutes',
                'data' => 'minutes',
                'title' => trans('time_management.minutes'),
    ...
    {
        return 'GracePeriod_' . date('YmdHis');
    }
}
