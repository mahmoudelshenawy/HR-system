...
class InsuranceProvidersDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'business-setup.medical-insurance.datatable_columns.action')
            ->rawColumns([
                'action',
            ]);
    }
    ...
    public function query(MedicalInsurance $model)
    {
    ...
    {
        return 'InsuranceProviders_' . date('YmdHis');
    }
}
