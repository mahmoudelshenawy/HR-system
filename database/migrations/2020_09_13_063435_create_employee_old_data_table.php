...
class CreateEmployeeOldDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_old_data', function (Blueprint $table) {
            $table->id();
            ...
            $table->char('healthy_certificate_cancel_date',15)->nullable();
            ...
            $table->enum('statue', ['active', 'inactive','resignation','retired','early_retirement','deceased'])->nullable();
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('employee_old_data');
    }
}
