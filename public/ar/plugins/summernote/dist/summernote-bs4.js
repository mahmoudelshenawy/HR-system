...
(function (global, factory) {
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-datatable_columns datatable_columns datatable_columns-light datatable_columns-sm" role="button" tabindex="-1">', function ($node, options) {
