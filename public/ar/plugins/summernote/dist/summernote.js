...
(function (global, factory) {
  ...
  var buttonGroup = renderer.create('<div class="note-datatable_columns-group datatable_columns-group">');
  ...
  var palette = renderer.create('<div class="note-color-palette"/>', function ($node, options) {
      ...
      for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
          ...
          for (var col = 0, colSize = colors.length; col < colSize; col++) {
              ...
              buttons.push([
                  '<button type="button" class="note-color-datatable_columns"',
      ...
      if (options.tooltip) {
          $node.find('.note-color-datatable_columns').tooltip({
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-datatable_columns datatable_columns datatable_columns-default datatable_columns-sm" role="button" tabindex="-1">', function ($node, options) {
