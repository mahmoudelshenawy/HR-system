...
<div class="modal custom-modal fade" id="delete_deduction_{{$id}}" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <div class="form-header">
                    <h3>{{__('general.delete')." ". __('employee.employee_deduction_data')}}</h3>
                    <p>{{__('general.daleteWarning')}}</p>
                </div>
                <div class="modal-btn delete-action">
                    <div class="row">
                        <div class="col-6">
                            <form method="post" action="employee_deduction/{{$id}}">
                                @csrf()
