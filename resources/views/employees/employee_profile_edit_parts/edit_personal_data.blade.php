                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="profile-img-wrap edit-img">
                            ...
                            {{asset('img/user.jpg')}} @endif alt="user">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class=" js-example-matcher-start" name="gender" >
                                        <option  value="{{$employee->gender}}" disabled  selected >
                                            @if($employee->gender == "male") {{ __('employee.male')}}
                                            @elseif($employee->gender == "female") {{__('employee.female')}}
                                            @else{{__('employee.select')}}
                                            @endif
                                        </option>
                            ...
                            <div class="col-6">
                                ...
                                <select class="select js-example-matcher-start"  style="width: 100%" name="country_id" >
                            ...
                            <div class="col-6">
                                ...
                                <select class="select js-example-matcher-start"  style="width: 100%" name="guarantor_id" >
