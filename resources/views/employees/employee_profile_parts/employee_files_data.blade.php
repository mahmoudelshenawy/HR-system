<div id="emp_profile" class=" tab-pane fade show active">
    <div class="row " style="background-color: whitesmoke">
        ...
        <div class="col-xl-3 col-md-6 col-sm-6">
            <h3 class="topic-title">{{trans('employee.national_card')}} <a href="#" class="edit-icon" data-toggle="modal" data-target="#national_id_edit"><i class="fa fa-pencil text-muted"></i></a></h3>
            <div class="card card-file">
                <div class="card-file-thumb" data-toggle="modal" data-target="#national_id" style="cursor: pointer;">
                    <i class="fa fa-file-pdf-o"></i>
                </div>
                <div class="card-body title">
                    <a class="title">{{trans('employee.national_id')}}
                        <span class="text-info">{{($employee->national_id_number)? $employee->national_id_number: ''}} </span>
                    </a><br>
                    <a  class="title">{{trans('employee.birth_day')}}
                        <span class="text-info">{{( ($employee->birth_date))?  $employee->birth_date: "  "}} </span>
                    </a>
                </div>
                <div class="card-footer">
                    <div style="display: inline-block" class="title">{{trans('employee.national_id_expiry_date')}}
        ...
        <!------------------------------start passport------------------------>
        <div class="col-xl-3 col-md-6 col-sm-6">
            <h3 class="topic-title">{{trans('employee.passport')}} <a href="#" class="edit-icon" data-toggle="modal" data-target="#passport_edit"><i class="fa fa-pencil text-muted"></i></a></h3>
            <div class="card card-file">
                <div class="card-file-thumb" data-toggle="modal" data-target="#passport" style="cursor: pointer;">
                    <i class="fa fa-file-pdf-o"></i>
                </div>
                <div class="card-body title">
        ...
        <!------------------------------start residence------------------------>
        <div class="col-xl-3 col-md-6 col-sm-6">
            <h3 class="topic-title">{{__('employee.residence')}} <a href="#" class="edit-icon" data-toggle="modal" data-target="#residence_edit"><i class="fa fa-pencil text-muted"></i></a></h3>
            <div class="card card-file">
                <div class="card-file-thumb" data-toggle="modal" data-target="#residence" style="cursor: pointer;">
                    <i class="fa fa-file-pdf-o"></i>
                </div>
                <div class="card-body title">
        ...
        <div class="col-xl-3 col-md-6 col-sm-6">
            <h3 class="topic-title">{{__('employee.healthy_certificate')}} <a href="#" class="edit-icon" data-toggle="modal" data-target="#healthy_certificate_edit"><i class="fa fa-pencil text-muted"></i></a></h3>
            <div class="card card-file">
                <div class="card-file-thumb" data-toggle="modal" data-target="#healthy_certificate" style="cursor: pointer;">
                    <i class="fa fa-file-pdf-o"></i>
                </div>
                <div class="card-body title">
        ...
        <div class="col-xl-3 col-md-6 col-sm-6">
            <h3 class="topic-title">{{__('employee.driving_licence')}} <a href="#" class="edit-icon" data-toggle="modal" data-target="#driving_licence_edit"><i class="fa fa-pencil text-muted"></i></a></h3>
            <div class="card card-file">
                <div class="card-file-thumb" data-toggle="modal" data-target="#driving_licence" style="cursor: pointer;">
                    <i class="fa fa-file-pdf-o"></i>
                </div>
                <div class="card-body title">
