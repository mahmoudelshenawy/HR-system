                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="profile-info-left">
                                    ...
                                    <div class="staff-msg"><a class="btn btn-custom" href="#">{{trans('employee.send_message')}}</a></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <ul class="personal-info">
                                    <li >
                                        ...
                                        <div style="display: inline-block" class="text"><a  href="tel:{{ $employee->phone_1 }}"> @if($employee->phone_1 ) <i class="fa fa-phone-square text-danger"></i> @endif</a></div>
                                    ...
                                    <li>
                                        ...
                                        <div style="display: inline-block" class="text"><a  href="tel:{{ $employee->phone_2 }}"> @if($employee->phone_2 ) <i class="fa fa-phone-square text-danger"></i> @endif</a></div>
                                    ...
                                    <li >
                                        ...
                                        <div style="display: inline-block" class="text"><a href="mailto:{{$employee->email }}">{{( ($employee->email))? $employee->email : ""}}</a> <i class="fa fa-mail-forward text-info"></i></div>
                                    </li>
                                    <li >
                                    ...
                                    <li>
                                        ...
                                        <div class="text" style="display: inline-block">{{($employee->religion)? $employee->religion: ''}} <i class="fa fa-moon-o"></i></div>
                                    </li>
