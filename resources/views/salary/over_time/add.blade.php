<div id="add_over_time" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('salary/over_time')}}" >
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="col-form-label">{{__('salary.over_time_amount')}}<span class="text-danger">*</span></label>
                                <input type="number" name="over_time_amount" class="form-control">
                            </div>
                        </div>
                    </div>
