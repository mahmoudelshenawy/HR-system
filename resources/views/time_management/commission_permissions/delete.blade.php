...
<div class="modal custom-modal fade" id="delete_commission_permissions{{$id}}" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <div class="col-6">
                            <form method="post" action="{{url('/time-management/commission_permissions/'.$id)}}">
                                @csrf()
