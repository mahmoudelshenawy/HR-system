<div id="add_custom_delay_penalty" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('time-management/custom-delay-penalties')}}" >
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="js-example-matcher-start" name="administration_id" multiple>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="minute_deduction" class="form-control">
                            </div>
                        </div>
                    </div>
